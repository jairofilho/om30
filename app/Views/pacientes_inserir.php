...
?>
<div class="conteudo">
    <div class="titulo">Inserir paciente</div>
    <div class="formulario">
        <form method="post" name="formulario" id="formulario" action="<?php echo $base; ?>/pacientes/criar" accept-charset="utf-8" enctype="multipart/form-data">
            <div class="linhaForm">
